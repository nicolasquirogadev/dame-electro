      ...
      <footer className="site-footer">
        <div className="footer-content">
          ...
          <div className="footer-info">
            ...
            <p>{businessAddress}</p>
            <p>Teléfono: +54 11 3073-3557</p>
            <p>Email: dameelectricidad.ventas@gmail.com</p>
            
            <div className="social-links">
              {/* Agrega aquí tus íconos de redes sociales si lo deseas */}
              <a href="https://www.instagram.com/dame.electricidad/"><i className="fa-brands fa-instagram"></i>@dame.electricidad</a>
